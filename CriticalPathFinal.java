...
public class CriticalPathFinal {
	...
	public static void main(String args[]) throws IOException {
		...
		CalculateEC(g, TopologicalOrderIndex);	//Calculate earliest completion time for all vertices considering s and t vertex
		CalculateLC(g, TopologicalOrderIndex);	//Calculate latest completion time for all vertices considering s and t vertex 
		CalculateSlack(g);	//Calculate  Slack for all the vertices considering S and T vertex
		
//		c.printCriticalPath(g, TopologicalOrderIndex);
		printCriticalSequence(g);
		PrintTable(g);
	 ...
	 */
	public static void CalculateEC(Graph graph, int[] TopologicalOrderIndex) {
	 ...
	 */
	public static void CalculateLC(Graph graph, int[] TopologicalOrderIndex) {	
	 ...
	 */
	public static void CalculateSlack(Graph graph) {
...
/*	public void printCriticalPath(Graph g, int[] TopologicalOrderIndex) {
	 ...
	 */
	public static void printCriticalSequence(Graph g) {
	 ...
	 */
	private static void Criticalpath(Graph g,Graph.Vertex u,LinkedList<Stack<Graph.Vertex>> differentPaths,Stack<Graph.Vertex> stackTemp) {

		Stack<Graph.Vertex> stack = new Stack<Graph.Vertex>();
		
		if (u.name==g.t.name && sum == g.t.lc) {	//check whether it reach the destination node
													//Check if the sum is same as destination t attribute lc time
				//Add to the stack 
